					...
					<div class="container">
						<div class="row">
							<section class="col-6 col-12-narrower feature">
								<h3>Forma për Kërkesë për Seancë</h3><br>
											...
											<table class="default">
												...
												<select name="ID_Seanca">
													<option selected="selected">Zgjedh Seancen</option>
														...
														{
															?>
													<option value="<?php echo $row['ID_Seanca']; ?>"><?php echo $row['Lloji_Seances']; ?></option>
															<?php
														}
														?>
												</select><br />
												...
												<tr> 
													<td>Mesazhi Shtesë</td>
													<td><input type="text" name="MesazhiShtese"></td>
												</tr>
												

												<tr> 
													<td></td>
													<td><input type="submit" name="shtokerkeseperseanc" value="Dërgo"></td>
												</tr>
