					...
					<div class="row">
						<section>
							...
							<form action="" method="post">  
								<table class="default">
	                                <tr>
	                                  <h3>Kërko kërkesën për seancë për modifikim</h3>
	                                </tr>
	                                	<br>
	                               	<tr>
										...
										WHERE
										  k.Emri LIKE '%".$term."%' OR k.Emaili LIKE '%".$term."%'"	); 
											...
											while($rresht = mysqli_fetch_array($sql)) { 		
													...
													echo "<td>".$rresht['MesazhiShtese']."</td>";
													echo "<td><a href=\"modifikokerkeseperseanc.php?ID_KerkesaS=$rresht[ID_KerkesaS]\" class='button'>Modifiko</a> </td></tr>";
