...
"SELECT * FROM umspo_psikologet ORDER BY ID_Psikologu DESC");
?>
<!DOCTYPE HTML>
<!--
						...
						<div class="row">
							<section>
								...
								<form action="" method="post">  
									<table class="default">
		                                <tr>
		                                  <h3>Kërko të dhënat e psikologut për fshirje</h3>
		                                </tr>
		                                 <br>
		                                <tr>
												...
												WHERE
												  p.Emri LIKE '%".$term."%' OR p.Emaili LIKE '%".$term."%'"	); 
													...
													while($rresht = mysqli_fetch_array($sql)) { 		
															...
															echo "<td><a href=\"fshipsikolog.php?ID_Psikologu=$rresht[ID_Psikologu]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini psikologun?')\" class='button'>Fshi</a> </td></tr>";	
														}
