					...
					<div class="container">
						<div class="row">
							<section class="col-6 col-12-narrower feature">
								...
								<h3>Shto psikologë</h3>
								<form enctype="multipart/form-data"action="shtopsikolog.php" method="post" name="form1">
										<table class="default">
												
												<tr>
												<select name="ID_Seanca">
													<option selected="selected">Zgjedh Seancën</option>
														<?php
												...
												<tr> 
													<td>Përshkrimi</td>
													<td><input type="text" name="PershkrimiP"></td>
												</tr>
												...
												<tr> 
													<td></td>
													<td><input type="submit" name="shtopsikolog" value="Shto"></td>
												</tr>
